...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtuser = findViewById(R.id.textNamaUserDaftar);
        txtpass = findViewById(R.id.passwordUserDaftar);
        txtemail = findViewById(R.id.textMailUserDaftar);
        txtponsel = findViewById(R.id.noHpUserDaftar);

        findViewById(R.id.btnConfirmDaftar).setOnClickListener(new View.OnClickListener() {
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() throws Exception {
            URL url = new URL("https://ius.mobile.indoserver.web.id/register.php");
