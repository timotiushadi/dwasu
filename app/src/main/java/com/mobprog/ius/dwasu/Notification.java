...
public class Notification extends AppCompatActivity {
    ...
    public static final String PRIMARY_CHANNEL_ID = "primary_notif_channel";
    ...
    public void createNotificationChannel(String idChannel, String nameChannel, String channelDesc) {
        ...
        mNotifyManager = (NotificationManager) getSystemService(MainActivity.NOTIFICATION_SERVICE);
    ...
    private NotificationCompat.Builder getNotificationBuilder(int builderID, String builderTitle, String builderText) {
        ...
        PendingIntent notificationPendingIntent = PendingIntent.getActivity
                (getApplicationContext(), builderID, notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);
