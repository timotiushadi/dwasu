...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtuser = findViewById(R.id.textMailUserLogin);
        txtpass = findViewById(R.id.passwordUserLogin);

        findViewById(R.id.btnSwitchtoDaftar).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.btnConfirmLogin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() throws Exception {
            URL url = new URL("https://ius.mobile.indoserver.web.id/login.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                if (!result.equalsIgnoreCase("FAILED")) {
                    ...
                    SharedPreferences.Editor mEditor = getSharedPreferences("Dwasu", 0).edit();
